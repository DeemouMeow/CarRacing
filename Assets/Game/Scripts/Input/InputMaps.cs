...
//     version 1.14.0
//     from Assets/Scripts/Input/InputMaps.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Scripts/Input/InputMaps.inputactions".
/// </summary>
/// <remarks>
...
public partial class @InputMaps: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""Movement"",
            ""id"": ""ee305091-7784-4b5a-bf60-172c82719f44"",
            ""actions"": [
                {
                    ""name"": ""Side"",
                    ""type"": ""Value"",
                    ""id"": ""0d0beeb6-4a95-4e76-820f-2f7aad836142"",
            ...
            ""bindings"": [
                {
                    ""name"": ""WASD"",
                    ""id"": ""b0c16423-1ba3-4f3b-8a00-b329a288546e"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""1f41d5fa-be51-4677-8ba0-e64903c4d69d"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""c0b64eb3-141b-438a-a5fc-a6b78776d087"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
        ...
        {
            ""name"": ""State"",
            ""id"": ""271e5fde-f03b-46a9-ad6a-f6bb520a4538"",
            ""actions"": [
                {
                    ""name"": ""Pause"",
                    ""type"": ""Button"",
                    ""id"": ""2a2c7c59-c3f2-49eb-9ede-4b5b672644fc"",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""8c9d95c9-6a3b-41b6-aab6-0833bcbe50bc"",
    ...
    ""controlSchemes"": []
        ...
        m_State_Pause = m_State.FindAction("Pause", throwIfNotFound: true);
    }

    ~@InputMaps()
    {
        UnityEngine.Debug.Assert(!m_Movement.enabled, "This will cause a leak and performance issues, InputMaps.Movement.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_State.enabled, "This will cause a leak and performance issues, InputMaps.State.Disable() has not been called.");
    }
    ...
    public struct MovementActions
    {
        ...
        /// </summary>
        public MovementActions(@InputMaps wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "Movement/Side".
        /// </summary>
    ...
    private readonly InputAction m_State_Pause;
    /// <summary>
    ...
    public struct StateActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public StateActions(@InputMaps wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "State/Pause".
        /// </summary>
        public InputAction @Pause => m_Wrapper.m_State_Pause;
        /// <summary>
        /// Provides access to the underlying input action map instance.
        /// </summary>
